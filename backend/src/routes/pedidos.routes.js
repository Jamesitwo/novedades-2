...
const { getAll, getById, updateEstado, remove, cotizarDropi, confirmarDropi, getResumen } = require('../controllers/pedidos.controller');
...
router.get('/resumen', adminOnly, getResumen);
