...
const { validateBody, validateParams, idParamSchema, novedadSchema, cambiarEstadoNovedadSchema, intentoSchema, bulkEstadoSchema, bulkAsignarSchema, transferirSchema } = require('../middlewares/validate.middleware');
