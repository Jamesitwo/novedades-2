                    ...
                    {cartItems.map(item => (
                      <div key={item.id} style={{ marginBottom: 8 }}>
                        ...
                        {!item.envioGratis && item.envioCosto > 0 && (
                          <div style={{ fontSize: 10, color: C.subtext, paddingLeft: 24 }}>+ Envío: {formatPrice(item.envioCosto)}</div>
                        )}
                        {item.envioGratis && (
                          <div style={{ fontSize: 10, color: '#22c55e', paddingLeft: 24 }}>+ Envío gratis</div>
                        )}
                      </div>
                    ))}
                  </div>
